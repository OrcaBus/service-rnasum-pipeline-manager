...
1. **Submit a test DRAFT event** using the [Manual Pipeline Execution SOP](../PM.RNS.1/PM.RNS.1-ManualPipelineExecution.md)
   - Use test libraries from the beta/dev environment
   - Ensure upstream Dragen WGTS RNA, Sash, and Arriba WGTS RNA runs have SUCCEEDED for the test libraries
