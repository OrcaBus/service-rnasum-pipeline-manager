# Deploying a New RNAsum Pipeline Version
...
cwl-ica icav2-zip-workflow \
  --workflow-path workflows/rnasum-pipeline/<version>/rnasum-pipeline__<version>.cwl \
  --force
```
...
Test the pipeline by submitting a manual DRAFT event. See [PM.RNS.1](../PM.RNS.1/PM.RNS.1-ManualPipelineExecution.md) for instructions.
