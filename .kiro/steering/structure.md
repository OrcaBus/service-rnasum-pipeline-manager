...
│   ├── get_arriba_wgts_rna_outputs_from_portal_run_id_py/
│   ├── get_draft_payload_py/
│   ├── get_dragen_wgts_rna_outputs_from_portal_run_id_py/
│   ├── get_fastq_id_list_from_rgid_list_py/
│   ├── get_fastq_rgids_from_library_id_py/
│   ├── get_latest_payload_from_portal_run_id_py/
│   ├── get_libraries_py/
│   ├── get_metadata_tags_py/
│   ├── get_sash_outputs_from_portal_run_id_py/
...
- **SSM prefix**: `/orcabus/workflows/rnasum/`
- **Stack prefix**: `orca-rnasum`
- **Workflow name**: `rnasum`
- **Lambda runtime**: Python 3.14 on ARM64
- **Upstream workflow names**: `dragen-wgts-rna`, `sash`, `arriba-wgts-rna` (glue pattern dependencies)
