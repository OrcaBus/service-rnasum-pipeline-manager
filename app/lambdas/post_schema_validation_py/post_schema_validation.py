...
def validate_inputs(
    ...
    # RNAsum inputs are all file URIs:
    #   - arribaPdf (file)
    #   - arribaTsv (file)
    #   - dragenFusions (file)
    #   - dragenMappingMetrics (file)
    #   - salmon (file) OR kallisto (file)
    #   - pcgrTiersTsv (file)
    #   - cnGeneTsv (file)
    #   - svTsv (file)
    data_uris: List[str] = []
...
#                             "projectId": "xxx",
#                             "pipelineId": "xxx",
#                             "outputUri": "s3://bucket/prefix/analysis/rnasum/portal-run-id/",
#                             "logsUri": "s3://bucket/prefix/logs/rnasum/portal-run-id/"
#                         },
#                         "inputs": {
#                             "arribaPdf": "s3://bucket/prefix/analysis/arriba-wgts-rna/xxx/arriba.pdf",
#                             "arribaTsv": "s3://bucket/prefix/analysis/arriba-wgts-rna/xxx/fusions.tsv",
#                             "dragenFusions": "s3://bucket/prefix/analysis/dragen-wgts-rna/xxx/fusions.csv",
#                             "dragenMappingMetrics": "s3://bucket/prefix/analysis/dragen-wgts-rna/xxx/mapping_metrics.csv",
#                             "salmon": "s3://bucket/prefix/analysis/dragen-wgts-rna/xxx/quant.sf",
#                             "pcgrTiersTsv": "s3://bucket/prefix/analysis/sash/xxx/pcgr.tiers.tsv",
#                             "cnGeneTsv": "s3://bucket/prefix/analysis/sash/xxx/purple.cnv.gene.tsv",
#                             "svTsv": "s3://bucket/prefix/analysis/sash/xxx/linx.svs.tsv",
#                             "dataset": "PANCAN",
#                             "reportDir": "RNAsum",
#                             "sampleName": "PRJ241540",
#                             "subjectId": "SBJ05828",
#                             "project": "Control"
#                         },
#                         "tags": {}
